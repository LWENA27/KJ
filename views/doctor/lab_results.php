                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            ...
                            <button 
                                data-patient-id="<?php echo $result['patient_id']; ?>"
                                data-patient-name="<?php echo htmlspecialchars($result['first_name'] . ' ' . $result['last_name']); ?>"
                                class="send-to-action-btn text-green-600 hover:text-green-900 focus:outline-none">
        ...
        <div class="bg-white w-full max-w-2xl rounded-xl shadow-2xl transform transition-all">
            ...
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200">
                <h3 class="text-xl font-bold text-gray-900 flex items-center">
                    ...
                    Next Steps for <span id="actionPatientName" class="ml-2"></span>
                </h3>
            ...
            <!-- Body -->
            <div class="px-6 py-4">
                <p class="text-gray-700 mb-6">Select an action to take based on the lab results:</p>
...
<script>
// Action Selection Modal functionality
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.action-option').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            const actions = {
                ...
                'services': () => window.location.href = `<?php echo $BASE_PATH; ?>/doctor/allocate_resources?patient_id=${patientId}`,

<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <h3 class="text-xl font-semibold text-gray-900 mb-4">Process Lab Test Payment</h3>

        <form method="POST" action="/KJ/lab/process_lab_payment" class="space-y-4">
            <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($csrf_token); ?>">
            <input type="hidden" name="patient_id" value="<?php echo $test['patient_id'] ?? ''; ?>">
            ...
            <div class="flex justify-end space-x-3">
                <a href="/KJ/lab/tests" class="px-4 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50">
                    Cancel
                </a>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="space-y-3">
            ...
            <div class="flex items-center">
                ...
                <span class="text-sm text-gray-600">Consultation Payment - Completed</span>
            </div>
            <div class="flex items-center">
                <div class="w-8 h-8 bg-yellow-100 rounded-full flex items-center justify-center mr-3">
                    <i class="fas fa-clock text-yellow-600"></i>
                </div>
                <span class="text-sm font-medium text-gray-900">Lab Tests Payment - Pending</span>
            </div>
            <div class="flex items-center">

...
--
-- Host: localhost:3306
-- Generation Time: Oct 05, 2025 at 01:39 PM
...
--
-- Table structure for table `backup_lab_test_orders`
--

CREATE TABLE `backup_lab_test_orders` (
  `id` int NOT NULL DEFAULT '0',
  `patient_id` int NOT NULL,
  `doctor_id` int NOT NULL,
  `tests_ordered` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `priority` enum('normal','urgent','stat') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'normal',
  ...
  `instructions` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Special instructions for the test'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Dumping data for table `backup_lab_test_orders`
--

INSERT INTO `backup_lab_test_orders` (`id`, `patient_id`, `doctor_id`, `tests_ordered`, `test_categories`, `total_amount`, `payment_status`, `amount_paid`, `payment_method`, `payment_date`, `notes`, `created_at`, `updated_at`, `status`, `priority`, `consultation_id`, `test_id`, `technician_id`, `sample_collected_at`, `expected_completion`, `instructions`) VALUES
...
CREATE TABLE `backup_payments` (
  ...
  `payment_method` enum('cash','card','insurance','other') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
--
-- Dumping data for table `backup_payments`
--

INSERT INTO `backup_payments` (`id`, `patient_id`, `consultation_id`, `amount`, `payment_method`, `payment_date`, `status`, `notes`, `created_by`) VALUES
(1, 27, NULL, 15000.00, 'cash', '2025-09-17 15:07:05', 'completed', NULL, 1),
(2, 27, NULL, 25000.00, 'cash', '2025-09-17 15:07:05', 'completed', NULL, 1),
(3, 27, NULL, 8000.00, 'cash', '2025-09-17 15:07:05', 'completed', NULL, 1),
(4, 27, NULL, 12000.00, 'cash', '2025-09-17 15:07:05', 'completed', NULL, 1),
(5, 27, NULL, 35000.00, 'cash', '2025-09-17 15:07:05', 'completed', NULL, 1),
(6, 27, NULL, 20000.00, 'cash', '2025-09-16 15:08:00', 'completed', NULL, 1),
(7, 27, NULL, 30000.00, 'cash', '2025-09-16 15:08:00', 'completed', NULL, 1),
(8, 27, NULL, 10000.00, 'cash', '2025-09-16 15:08:00', 'completed', NULL, 1);
...
CREATE TABLE `consultation_overrides` (
  ...
  `doctor_id` int NOT NULL,
  `override_reason` text NOT NULL COMMENT 'Doctor explanation for starting without payment',
  `override_date` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `payment_collected_at` timestamp NULL DEFAULT NULL,
  `collected_by` int DEFAULT NULL COMMENT 'Receptionist who collected payment',
  `amount` decimal(10,2) DEFAULT '3000.00' COMMENT 'Amount in TSH',
  `status` enum('pending_payment','paid','waived') DEFAULT 'pending_payment'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Track consultations started without payment with doctor override';
...
INSERT INTO `lab_results` (`id`, `consultation_id`, `test_id`, `technician_id`, `result_value`, `result_text`, `status`, `sample_date`, `result_date`, `notes`, `created_at`, `updated_at`, `lab_order_id`, `patient_id`, `result_unit`, `interpretation`, `technician_notes`, `is_normal`, `is_critical`, `completed_at`, `reviewed_by`, `reviewed_at`) VALUES
(11, 11, 1, 10, NULL, NULL, 'pending', NULL, NULL, NULL, '2025-09-14 05:18:49', '2025-09-14 05:18:49', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL);
...
(24, 'Paracetamol 500mg', 'Paracetamol', 'Pain and fever relief tablets', 500, 200.00, '2025-12-31', 'Pharmaceutical Supplies Ltd', '2025-09-18 15:12:58', '2025-09-18 15:12:58'),
(25, 'Amoxicillin 250mg', 'Amoxicillin', 'Antibiotic capsules', 300, 800.00, '2025-11-30', 'MedCorp Ltd', '2025-09-18 15:12:58', '2025-09-18 15:12:58'),
(26, 'Ibuprofen 400mg', 'Ibuprofen', 'Anti-inflammatory tablets', 200, 300.00, '2025-10-15', 'HealthCare Supplies', '2025-09-18 15:12:58', '2025-09-18 15:12:58'),
(27, 'Artemether-Lumefantrine', 'AL', 'Antimalarial tablets', 150, 2500.00, '2025-09-30', 'Global Health Supplies', '2025-09-18 15:12:58', '2025-09-18 15:12:58'),
(28, 'Metformin 500mg', 'Metformin', 'Diabetes management tablets', 250, 500.00, '2026-01-15', 'Pharmaceutical Supplies Ltd', '2025-09-18 15:12:58', '2025-09-18 15:12:58'),
(29, 'Oral Rehydration Salt', 'ORS', 'Electrolyte replacement sachets', 100, 1000.00, '2026-03-30', 'HealthCare Supplies', '2025-09-18 15:12:58', '2025-09-18 15:12:58'),
(30, 'Albendazole 400mg', 'Albendazole', 'Deworming tablets', 180, 800.00, '2025-08-20', 'MedCorp Ltd', '2025-09-18 15:12:58', '2025-09-18 15:12:58'),
(31, 'Cotrimoxazole 480mg', 'Cotrimoxazole', 'Antibiotic tablets', 120, 600.00, '2025-12-15', 'Global Health Supplies', '2025-09-18 15:12:58', '2025-09-18 15:12:58');
...
CREATE TABLE `medicine_dispensing` (
  ...
  `dispensed_by` int NOT NULL COMMENT 'Staff who dispensed (receptionist)',
  `dispensed_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `notes` text
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Track individual medicine dispensing for partial payments';
...
(31, 'KJ20250003', 'adam', 'lwena', '2001-02-07', 'male', '0683274343', 'adamlwena22@gmai.com', '', '', 'consultation', NULL, NULL, 'pending', 0, 0, 0, 0, 'consultation_registration', 0, 'adam samson lwena', '0683274343', 0.0, '', 0, 0.0, 0.0, NULL, '2025-09-13 07:48:51', '2025-09-13 07:48:51'),
(32, 'KJ20250004', 'adam', 'lwena', '2000-09-09', 'male', '0683274343', 'adamlwena22@gmai.com', '', '', 'consultation', NULL, NULL, 'pending', 0, 0, 0, 0, 'consultation_registration', 0, 'adam samson lwena', '0683274343', 0.0, '', 0, 0.0, 0.0, NULL, '2025-09-13 08:37:12', '2025-09-13 08:37:12'),
(33, 'KJ20250005', 'adam', 'lwena', '2025-09-02', 'male', '0683274343', 'adamlwena22@gmai.com', '', '', 'consultation', NULL, NULL, 'pending', 0, 0, 0, 0, 'consultation_registration', 0, 'adam samson lwena', '0683274343', 0.0, '', 0, 0.0, 0.0, NULL, '2025-09-14 18:48:34', '2025-09-14 18:48:34');
...
CREATE TABLE `patient_queue` (
  `id` int NOT NULL,
  `patient_id` int NOT NULL,
  `current_location` enum('reception','doctor','lab','pharmacy','completed','left') NOT NULL DEFAULT 'reception',
  `current_status` enum('waiting','being_served','pending_payment','completed') NOT NULL DEFAULT 'waiting',
  `assigned_to` int DEFAULT NULL COMMENT 'Staff currently serving patient',
  `queue_number` int DEFAULT NULL COMMENT 'Queue position number',
  `priority` enum('normal','urgent','emergency') DEFAULT 'normal',
  `arrived_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `last_updated` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `notes` text
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Track patient movement through dispensary workflow';
...
INSERT INTO `payments` (`id`, `patient_id`, `consultation_id`, `amount`, `payment_method`, `payment_date`, `status`, `notes`, `created_by`) VALUES
(1, 27, NULL, 15000.00, 'cash', '2025-09-17 15:07:05', 'completed', NULL, 1),
(2, 27, NULL, 25000.00, 'cash', '2025-09-17 15:07:05', 'completed', NULL, 1),
(3, 27, NULL, 8000.00, 'cash', '2025-09-17 15:07:05', 'completed', NULL, 1),
(4, 27, NULL, 12000.00, 'cash', '2025-09-17 15:07:05', 'completed', NULL, 1),
...
INSERT INTO `tests` (`id`, `name`, `description`, `category`, `price`, `normal_range`, `unit`, `created_at`, `updated_at`, `requires_fasting`) VALUES
(1, 'Complete Blood Count', 'CBC test for blood analysis', 'Hematology', 25000.00, '4.5-11.0', '10^9/L', '2025-08-31 14:09:11', '2025-09-19 14:34:15', 0),
(2, 'Blood Glucose', 'Fasting blood sugar test', 'Biochemistry', 15000.00, '70-100', 'mg/dL', '2025-08-31 14:09:11', '2025-09-19 14:34:15', 0),
(3, 'Urine Analysis', 'Urinalysis test', 'Urinalysis', 10000.00, 'Normal', 'N/A', '2025-08-31 14:09:11', '2025-09-19 14:34:15', 0),
(4, 'Malaria Rapid Test', 'Quick malaria detection test', 'Parasitology', 8000.00, 'Negative', 'Result', '2025-09-03 02:02:23', '2025-09-19 14:34:15', 0),
(5, 'HIV Test', 'HIV antibody screening test', 'Serology', 20000.00, 'Non-reactive', 'Result', '2025-09-03 02:02:23', '2025-09-19 14:34:15', 0),
(6, 'Hepatitis B Surface Antigen', 'HBsAg screening test', 'Serology', 15000.00, 'Non-reactive', 'Result', '2025-09-03 02:02:24', '2025-09-19 14:34:15', 0),
(7, 'Liver Function Test', 'Complete liver enzyme panel', 'Biochemistry', 35000.00, 'Normal', 'Units', '2025-09-03 02:02:24', '2025-09-19 14:34:15', 0),
(8, 'Kidney Function Test', 'Creatinine and urea analysis', 'Biochemistry', 25000.00, 'Normal', 'mg/dL', '2025-09-03 02:02:24', '2025-09-19 14:34:15', 0),
(9, 'Lipid Profile', 'Complete cholesterol analysis', 'Biochemistry', 30000.00, 'Normal', 'mg/dL', '2025-09-03 02:02:24', '2025-09-19 14:34:15', 0),
(10, 'Thyroid Function Test', 'TSH, T3, T4 analysis', 'Endocrinology', 45000.00, 'Normal', 'mIU/L', '2025-09-03 02:02:24', '2025-09-19 14:34:15', 0),
(11, 'Stool Analysis', 'Comprehensive stool examination', 'Microbiology', 12000.00, 'Normal', 'Result', '2025-09-03 02:02:24', '2025-09-19 14:34:15', 0),
(12, 'Pregnancy Test', 'HCG pregnancy detection', 'Serology', 5000.00, 'Negative/Positive', 'Result', '2025-09-03 02:02:24', '2025-09-19 14:34:15', 0),
(13, 'ESR (Erythrocyte Sedimentation Rate)', 'Inflammation marker test', 'Hematology', 10000.00, '0-20 mm/hr', 'mm/hr', '2025-09-03 02:02:24', '2025-09-19 14:34:15', 0),
(14, 'Full Blood Count (FBC)', 'Complete blood count including WBC, RBC, platelets', 'Hematology', 25000.00, '4.5-11.0 x10^9/L', 'x10^9/L', '2025-09-18 15:11:20', '2025-09-18 15:11:20', 0),
(15, 'Malaria Test (mRDT)', 'Rapid diagnostic test for malaria parasites', 'Parasitology', 8000.00, 'Negative', '', '2025-09-18 15:11:20', '2025-09-18 15:11:20', 0),
(16, 'Blood Sugar (Random)', 'Random blood glucose test', 'Biochemistry', 5000.00, '70-140 mg/dL', 'mg/dL', '2025-09-18 15:11:20', '2025-09-18 15:11:20', 0),
(17, 'Urine Analysis', 'Complete urine examination', 'Biochemistry', 10000.00, 'Normal', '', '2025-09-18 15:11:20', '2025-09-18 15:11:20', 0),
(18, 'Hepatitis B Surface Antigen', 'HBsAg test', 'Serology', 15000.00, 'Non-reactive', '', '2025-09-18 15:11:20', '2025-09-18 15:11:20', 0),
(19, 'HIV Test', 'HIV 1&2 antibodies', 'Serology', 12000.00, 'Non-reactive', '', '2025-09-18 15:11:20', '2025-09-18 15:11:20', 0),
(20, 'Pregnancy Test', 'Beta-hCG test', 'Serology', 8000.00, 'Negative', '', '2025-09-18 15:11:20', '2025-09-18 15:11:20', 0),
(21, 'Stool Analysis', 'Microscopic examination of stool', 'Parasitology', 8000.00, 'No parasites seen', '', '2025-09-18 15:11:20', '2025-09-18 15:11:20', 0);
...
INSERT INTO `users` (`id`, `username`, `password_hash`, `email`, `role`, `first_name`, `last_name`, `phone`, `created_at`, `updated_at`, `is_active`, `permissions`) VALUES
(1, 'admin', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin@hospital.com', 'admin', 'System', 'Administrator', '1234567890', '2025-08-31 14:09:11', '2025-08-31 14:09:11', 1, NULL),
(3, 'doctor1', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'doctor@hospital.com', 'doctor', 'Dr. John', 'Doe', '1234567892', '2025-08-31 14:09:11', '2025-08-31 14:09:11', 1, NULL),
(9, 'manu', '$2y$10$Vmi9WgDmoYCaDfmAne.yi.4DCwjSo2PDAqrXZaJiPL3qlLHclvFlC', 'man@gmail.com', 'receptionist', 'manfred', 'tembo', '0711111111', '2025-09-13 10:06:38', '2025-09-13 10:06:38', 1, NULL),
(10, 'zanura', '$2y$10$1WyDH.zYxdLovxA90W/0.uWdRZWMK3t5BPKCwp1/.idgaYvz.kWKu', 'zanura@gmail.com', 'lab_technician', 'zanura', 'zanura', '0683274343', '2025-09-13 14:12:49', '2025-09-13 14:12:49', 1, NULL),
(11, 'receptionist', '$2y$10$Ucq7VV/0Ep68wFj0yNk3wOVUk1hlxIIDKsmRfn4jK9FGGnKcXRFbu', 'adamlwena22@gmai.com', 'receptionist', 'adam', 'lwena', '0683274343', '2025-09-14 18:07:46', '2025-09-14 18:07:46', 1, NULL),
(12, 'lab', '$2y$10$VsQ6LOJb2hlvEBNoAD681OaxheWjjf2aHHnXS0z/3CkI3jp0SVvqy', 'lab@gmail.com', 'receptionist', 'lab', 'lab', '0612345678', '2025-09-19 14:25:32', '2025-09-19 14:25:32', 1, NULL),
(13, 'lab2', '$2y$10$Vrfs072R4K8m06VLwN6bTO9IS0o7y.VFIfTlxNJi/euCC4fqsRfO6', 'lab1@gmail.com', 'lab_technician', 'lab2', 'lab2', '0612345679', '2025-09-19 14:27:17', '2025-09-19 14:27:17', 1, NULL),
(14, 'testapi3', '$2a$10$WHRgqj6xwlgFNTyZW3aUI.VWNvOGQy97hFK7ZoD0u.rBOUm5UfWjC', '', 'receptionist', 'Test3', 'Api3', NULL, '2025-09-30 21:53:01', '2025-09-30 21:53:01', 1, NULL);
...
ALTER TABLE `consultation_overrides`
  ...
  ADD KEY `idx_consultation_overrides_status` (`status`);
...
ALTER TABLE `medicine_orders`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_patient_medicine` (`patient_id`),
  ADD KEY `idx_doctor_medicine` (`doctor_id`),
  ADD KEY `idx_payment_status` (`payment_status`),
  ADD KEY `idx_dispensing_status` (`dispensing_status`);
...
ALTER TABLE `patient_queue`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_active_patient` (`patient_id`) COMMENT 'Each patient can only be in queue once',
  ADD KEY `assigned_to` (`assigned_to`),
  ADD KEY `idx_patient_queue_location` (`current_location`),
  ADD KEY `idx_patient_queue_status` (`current_status`);
...
--
-- Constraints for table `consultation_overrides`
--
ALTER TABLE `consultation_overrides`
  ADD CONSTRAINT `consultation_overrides_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `consultation_overrides_ibfk_2` FOREIGN KEY (`consultation_id`) REFERENCES `consultations` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `consultation_overrides_ibfk_3` FOREIGN KEY (`doctor_id`) REFERENCES `users` (`id`) ON DELETE RESTRICT,
  ADD CONSTRAINT `consultation_overrides_ibfk_4` FOREIGN KEY (`collected_by`) REFERENCES `users` (`id`) ON DELETE SET NULL;
...
ALTER TABLE `medicine_dispensing`
  ...
  ADD CONSTRAINT `medicine_dispensing_ibfk_2` FOREIGN KEY (`dispensed_by`) REFERENCES `users` (`id`) ON DELETE RESTRICT;

--
-- Constraints for table `medicine_orders`
--
ALTER TABLE `medicine_orders`
  ADD CONSTRAINT `medicine_orders_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`id`),
  ADD CONSTRAINT `medicine_orders_ibfk_2` FOREIGN KEY (`doctor_id`) REFERENCES `users` (`id`);
...
--
ALTER TABLE `patient_queue`
  ADD CONSTRAINT `patient_queue_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `patient_queue_ibfk_2` FOREIGN KEY (`assigned_to`) REFERENCES `users` (`id`) ON DELETE SET NULL;

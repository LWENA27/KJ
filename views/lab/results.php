<div class="w-full px-6 space-y-6">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex items-center space-x-3">
            ...
            <a href="<?php echo htmlspecialchars($BASE_PATH); ?>/lab/tests" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors">

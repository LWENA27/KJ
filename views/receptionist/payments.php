        ...
        <form id="paymentForm" method="POST" action="/KJ/receptionist/record_payment" class="p-6">
            ...
            <div class="space-y-4">
                ...
                <div id="modal_total_cost_container" class="bg-blue-50 rounded-lg p-4 border-2 border-blue-200 hidden">
                    <label class="block text-sm font-medium text-gray-700 mb-1">Total Prescription Cost</label>
                    <p id="modal_total_cost_display" class="text-xl font-bold text-blue-600"></p>
                </div>

                <!-- New: Amount Already Paid (visible for medicine payments) -->
                <div id="modal_amount_paid_container" class="bg-green-50 rounded-lg p-4 border-2 border-green-200 hidden">
                    <label class="block text-sm font-medium text-gray-700 mb-1">Amount Already Paid</label>
